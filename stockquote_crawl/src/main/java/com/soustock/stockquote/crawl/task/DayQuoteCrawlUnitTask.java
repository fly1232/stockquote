 ...
 * 处理单个股票
 */
public class DayQuoteCrawlUnitTask implements Runnable {

    private final static Log logger = LogFactory.getLog(DayQuoteCrawlUnitTask.class);
    ...
    private void fetchQuoteForEachStock(String stockCode) throws IOException {
        ...
        getQuoteObjs(stockCode, stockInfoVo.getListDate(), maxDate);
    }
